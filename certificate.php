...
<?php
include_once "./connection.php";               // Collecting data from query string
$id=$_GET['edit'];                            //echo $id;
...
if($stmt = $conn->prepare($count))
{
 ...
 $row=$result->fetch_object();
  ...
  ?>
    ...
    <h1 class="k">This certifies that</h5> 
    ...
    <!-- <img src="image/"+"  -->
        ...
        <div class="m"> 
            <h4 class="n"><img src="images/<?php echo $row->pfile ?>">
            <?php echo $row->pname ?> </h4>
            <h4 class="o"><img src="images/<?php echo $row->sfile ?>">
            <?php echo $row->sname ?></h4>

        </div>
    
    <?php 
    echo '<div class="p"> <h5 class="q" >President</h5> <h5 class= "r" > Secretary</h5> </div>';
